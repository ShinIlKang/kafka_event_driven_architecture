...
public class CouponIssueRequestHistoryAdapter implements CouponIssueRequestHistoryPort {
    ...
    private static final String REQUEST_COUNT_HISTORY_KEY_PREFIX = "coupon_history.request_request.v1:";
    ...
    public Long getRequestSequentialNumber(Long couponEventId) {
        ...
        Long requestSequentialNumber = redisTemplate.opsForValue().increment(key); // key를 증가한 값을 리턴해줌
        if (requestSequentialNumber != null && requestSequentialNumber == 1) { // 만약 키가 처음 생성 되었다면
